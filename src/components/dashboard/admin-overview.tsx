      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-[10px] text-muted-foreground font-bold uppercase">System Active</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="shadow-sm border-border rounded-xl">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                ...
                <Users className={cn("h-4 w-4", effectiveOccupancy > 0 ? "text-green-600 animate-pulse" : "text-slate-400")} />
              </CardHeader>
              <CardContent>
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold tracking-tight text-slate-900">{effectiveOccupancy}</span>
            ...
            <Card className="shadow-sm border-border rounded-xl bg-slate-50/50">
              ...
              <CardContent><div className="text-sm font-bold text-primary truncate">2024-2025</div></CardContent>
            </Card>
          </div>
